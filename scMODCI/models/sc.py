...
#         ptr_dim = in_features
#         hin_dim=h_dim
#         self.h_dim = KANLinear(ptr_dim, hin_dim)
#         self.bn=torch.nn.BatchNorm1d(hin_dim)
#         self.loc = KANLinear(h_dim, out_features)
#         self.std_lin = KANLinear(hin_dim, out_features)
...
#         self.h_dim = KANLinear(ptr_dim, hin_dim)
#         self.bn=torch.nn.BatchNorm1d(hin_dim)
#         self.loc = KANLinear(hin_dim, out_features)
#         self.std_lin = KANLinear(hin_dim, out_features)
#         #self.loc = torch.nn.Linear(ptr_dim, out_features)
#         #self.std_lin = torch.nn.Linear(ptr_dim, out_features)
#
...
#         std = F.softplus(self.std_lin(ptr)) + EPS
#         return D.Normal(loc, std)
#-------------------------- Network modules for scMODCI ---------------------------

class GraphEncoder(MODCI.GraphEncoder):
...
class GraphDecoder(MODCI.GraphDecoder):
...
class DataEncoder(MODCI.DataEncoder):
...
class DataDecoder(MODCI.DataDecoder):
...
class Discriminator(torch.nn.Sequential, MODCI.Discriminator):
...
#-------------------- Network modules for independent scMODCI ---------------------
