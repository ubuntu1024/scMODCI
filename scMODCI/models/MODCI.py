...
class SCMODCI(torch.nn.Module):
    ...
    def __init__(
            ...
            du: Discriminator,
            #du_gen: Mapping[str, Discriminator_gen],
            prior: Prior
    ) -> None:
        super().__init__()
    ...
    def forward(self) -> NoReturn:
        ...
        """
        raise RuntimeError("SCMODCI does not support forward operation!")
