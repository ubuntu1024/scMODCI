...
def integration_consistency(
        model: SCMODCIModel, adatas: Mapping[str, AnnData],
    ...
    **kwargs
        ...
        :func:`scmodci.data.metacell_corr`
    ...
    for k, adata in adatas.items():
        adata.obsm["X_scMODCI"] = model.encode_data(k, adata)
    ...
    for n_meta in (10, 20, 50, 100, 200):
        ...
        corr = metacell_corr(
            *adatas.values(), skeleton=graph,
            use_rep="X_scMODCI", n_meta=n_meta, **kwargs
        )
